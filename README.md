...
Pantheon is website platform optimized and configured to run high performance sites with an amazing developer workflow. There is built-in support for features such as Redis, Apache Solr, New Relic, Nginx, PHP-FPM, MariaDB and more. 
