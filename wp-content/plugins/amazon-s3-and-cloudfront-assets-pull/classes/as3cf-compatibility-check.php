...
if ( ! class_exists( 'AS3CF_Compatibility_Check' ) ) {
	...
	class AS3CF_Compatibility_Check {
		...
		public function get_sdk_error_msg() {
			...
			$msg = __( 'The official Amazon&nbsp;Web&nbsp;Services SDK requires PHP 5.5+ and cURL 7.16.2+ compiled with OpenSSL and zlib. Your server currently has', 'as3cf-assets-pull' );
