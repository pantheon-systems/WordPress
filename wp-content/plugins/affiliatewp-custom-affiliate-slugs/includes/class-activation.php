...
class AffiliateWP_Activation {
    ...
    public function __construct( $plugin_path, $plugin_file ) {
        ...
        if ( isset( $plugins[$this->plugin_path . '/' . $this->plugin_file]['Name'] ) ) {
            ...
            $this->plugin_name = __( 'This plugin', 'affiliatewp-custom-affiliate-slugs' );
        }
    ...
    public function missing_affiliatewp_notice() {
        ...
        if ( $this->has_affiliatewp ) {
           echo '<div class="error"><p>' .  $this->plugin_name . ' ' . sprintf( __( 'requires %s. Please activate it to continue.', 'affiliatewp-custom-affiliate-slugs' ), '<a href="https://affiliatewp.com/" target="_blank">AffiliateWP</a>' ) . '</p></div>';

        } else {
            echo '<div class="error"><p>' . $this->plugin_name . ' ' . sprintf( __( 'requires %s. Please install it to continue.', 'affiliatewp-custom-affiliate-slugs' ), '<a href="https://affiliatewp.com/" target="_blank">AffiliateWP</a>' ) . '</p></div>';
        }
    }
}
