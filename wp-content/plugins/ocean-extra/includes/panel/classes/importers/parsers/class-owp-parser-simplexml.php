...
/**
 * OWP Parser that makes use of the SimpleXML PHP extension.
 */
class OWP_Parser_SimpleXML {
	function parse( $file ) {
		...
		if ( ! $wxr_version )
			return new WP_Error( 'WXR_parse_error', __( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'ocean-extra' ) );
