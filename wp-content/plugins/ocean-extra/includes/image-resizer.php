...
if ( ! class_exists( 'Ocean_Extra_Resize' ) ) {
    ...
    class Ocean_Extra_Resize {
        ...
        /**
         * Should an Ocean_Extra_Exception be thrown on error?
            ...
            try {
                ...
                if ( ! $dims && ( ( ( null === $height && $orig_w == $width ) xor ( null === $width && $orig_h == $height ) ) xor ( $height == $orig_h && $width == $orig_w ) ) ) {
                    ...
                    if ( ! $dims || ( true == $crop && false == $upscale && ( $dst_w < $width || $dst_h < $height ) ) ) {
                        ...
                        throw new Ocean_Extra_Exception('Unable to resize image because image_resize_dimensions() failed');
                    }
                    ...
                    // Else, we resize the image and return the new resized image url.
                        ...
                        if ( is_wp_error( $editor ) || is_wp_error( $editor->resize( $width, $height, $crop ) ) ) {
                            throw new Ocean_Extra_Exception('Unable to get WP_Image_Editor: ' . 
...
if ( ! function_exists( 'ocean_extra_resize' ) ) {

    /**
     * This is just a tiny wrapper function for the class above so that there is no
     * need to change any code in your own WP themes. Usage is still the same :)
     */
    function ocean_extra_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        /* WPML Fix */
        ...
        $ocean_extra_resize = Ocean_Extra_Resize::getInstance();
        return $ocean_extra_resize->process( $url, $width, $height, $crop, $single, $upscale );
    }
}

if ( ! function_exists( 'ocean_extra_image_attributes' ) ) {

    /**
     * Build our image attributes
     */
    function ocean_extra_image_attributes( $og_width = '', $og_height = '', $new_width = '', $new_height = '' ) {
        ...
        return apply_filters( 'ocean_extra_image_attributes', $img_atts );
    }
}