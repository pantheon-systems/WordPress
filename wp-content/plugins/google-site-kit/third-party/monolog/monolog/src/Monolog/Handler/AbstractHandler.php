 ...
 */
abstract class AbstractHandler implements \Google\Site_Kit_Dependencies\Monolog\Handler\HandlerInterface, \Google\Site_Kit_Dependencies\Monolog\ResettableInterface
{
    protected $level = \Google\Site_Kit_Dependencies\Monolog\Logger::DEBUG;
