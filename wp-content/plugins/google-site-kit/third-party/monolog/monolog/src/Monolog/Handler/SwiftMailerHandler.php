...
class SwiftMailerHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\MailHandler
{
     ...
     */
    public function __construct(\Google\Site_Kit_Dependencies\Swift_Mailer $mailer, $message, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::ERROR, $bubble = \true)
    {
