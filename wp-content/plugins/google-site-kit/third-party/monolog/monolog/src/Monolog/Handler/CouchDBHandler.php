 ...
 */
class CouchDBHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = array(), $level = \Google\Site_Kit_Dependencies\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    {
        return new \Google\Site_Kit_Dependencies\Monolog\Formatter\JsonFormatter(\Google\Site_Kit_Dependencies\Monolog\Formatter\JsonFormatter::BATCH_MODE_JSON, \false);
    }
}
