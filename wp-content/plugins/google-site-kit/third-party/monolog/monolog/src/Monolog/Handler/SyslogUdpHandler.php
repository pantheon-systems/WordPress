...
use Google\Site_Kit_Dependencies\Monolog\Handler\SyslogUdp\UdpSocket;
/**
...
class SyslogUdpHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractSyslogHandler
{
     ...
     */
    public function __construct($host, $port = 514, $facility = \LOG_USER, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::DEBUG, $bubble = \true, $ident = 'php', $rfc = self::RFC5424)
    {
        parent::__construct($facility, $level, $bubble);
        $this->ident = $ident;
        $this->rfc = $rfc;
        $this->socket = new \Google\Site_Kit_Dependencies\Monolog\Handler\SyslogUdp\UdpSocket($host, $port ?: 514);
    }
