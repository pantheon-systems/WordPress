 ...
 */
class SlackbotHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::CRITICAL, $bubble = \true)
    {
