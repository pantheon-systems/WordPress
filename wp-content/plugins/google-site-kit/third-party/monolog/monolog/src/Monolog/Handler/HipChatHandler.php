 ...
 */
class HipChatHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\SocketHandler
{
    /**
     * Use API version 1
     */
     ...
     */
    public function __construct($token, $room, $name = 'Monolog', $notify = \false, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $format = 'text', $host = 'api.hipchat.com', $version = self::API_V1)
    {
    ...
    {
        switch (\true) {
            case $level >= \Google\Site_Kit_Dependencies\Monolog\Logger::ERROR:
                return 'red';
            case $level >= \Google\Site_Kit_Dependencies\Monolog\Logger::WARNING:
                return 'yellow';
            case $level >= \Google\Site_Kit_Dependencies\Monolog\Logger::INFO:
                return 'green';
            case $level == \Google\Site_Kit_Dependencies\Monolog\Logger::DEBUG:
                return 'gray';
            default:
                return 'yellow';
        }
