...
class PushoverHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct($token, $users, $title = null, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \Google\Site_Kit_Dependencies\Monolog\Logger::CRITICAL, $emergencyLevel = \Google\Site_Kit_Dependencies\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
