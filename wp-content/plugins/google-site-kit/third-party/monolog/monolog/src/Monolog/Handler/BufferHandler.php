 ...
 */
class BufferHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractHandler
{
    protected $handler;
     ...
     */
    public function __construct(\Google\Site_Kit_Dependencies\Monolog\Handler\HandlerInterface $handler, $bufferLimit = 0, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::DEBUG, $bubble = \true, $flushOnOverflow = \false)
    {
