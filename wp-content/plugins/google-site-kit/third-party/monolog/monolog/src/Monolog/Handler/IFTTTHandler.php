 ...
 */
class IFTTTHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractProcessingHandler
{
    private $eventName;
    private $secretKey;
    /**
     ...
     */
    public function __construct($eventName, $secretKey, $level = \Google\Site_Kit_Dependencies\Monolog\Logger::ERROR, $bubble = \true)
    {
