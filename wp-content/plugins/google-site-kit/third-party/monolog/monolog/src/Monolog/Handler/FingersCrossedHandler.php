...
use Google\Site_Kit_Dependencies\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
 ...
 */
class FingersCrossedHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractHandler
{
    protected $handler;
