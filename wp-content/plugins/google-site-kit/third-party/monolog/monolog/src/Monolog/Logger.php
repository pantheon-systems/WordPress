...
use Google\Site_Kit_Dependencies\Monolog\Handler\HandlerInterface;
use Google\Site_Kit_Dependencies\Monolog\Handler\StreamHandler;
use Google\Site_Kit_Dependencies\Psr\Log\LoggerInterface;
use Google\Site_Kit_Dependencies\Psr\Log\InvalidArgumentException;
use Exception;
/**
 * Monolog log channel
 *
...
class Logger implements \Google\Site_Kit_Dependencies\Psr\Log\LoggerInterface, \Google\Site_Kit_Dependencies\Monolog\ResettableInterface
{
     ...
     * @return $this
     */
    public function pushHandler(\Google\Site_Kit_Dependencies\Monolog\Handler\HandlerInterface $handler)
    {
    ...
    {
        if (!$this->handlers) {
            $this->pushHandler(new \Google\Site_Kit_Dependencies\Monolog\Handler\StreamHandler('php://stderr', static::DEBUG));
        }
