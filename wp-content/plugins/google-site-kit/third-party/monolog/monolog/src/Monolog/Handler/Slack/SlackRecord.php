...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \Google\Site_Kit_Dependencies\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \Google\Site_Kit_Dependencies\Monolog\Formatter\NormalizerFormatter();
        }
    }
