 ...
 */
class ChromePHPHandler extends \Google\Site_Kit_Dependencies\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \Google\Site_Kit_Dependencies\Monolog\Formatter\ChromePHPFormatter();
    }
    /**
