 ...
 * the License.
 */
class Google_Service_TagManager_Tag extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    public $path;
    public $paused;
    protected $priorityType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_Parameter';
    protected $priorityDataType = '';
    public $scheduleEndMs;
    public $scheduleStartMs;
    protected $setupTagType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_SetupTag';
    protected $setupTagDataType = 'array';
    public $tagFiringOption;
    public $tagId;
    public $tagManagerUrl;
    protected $teardownTagType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_TeardownTag';
     ...
     * @param Google_Service_TagManager_Parameter
     */
    public function setPriority(\Google\Site_Kit_Dependencies\Google_Service_TagManager_Parameter $priority)
    {
