 ...
 * the License.
 */
class Google_Service_Analytics_UnsampledReport extends \Google\Site_Kit_Dependencies\Google_Model
{
    protected $internal_gapi_mappings = array("endDate" => "end-date", "startDate" => "start-date");
    public $accountId;
    protected $cloudStorageDownloadDetailsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails';
    protected $cloudStorageDownloadDetailsDataType = '';
    public $created;
    public $dimensions;
    public $downloadType;
    protected $driveDownloadDetailsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_UnsampledReportDriveDownloadDetails';
     ...
     */
    public function setCloudStorageDownloadDetails(\Google\Site_Kit_Dependencies\Google_Service_Analytics_UnsampledReportCloudStorageDownloadDetails $cloudStorageDownloadDetails)
    {
     ...
     */
    public function setDriveDownloadDetails(\Google\Site_Kit_Dependencies\Google_Service_Analytics_UnsampledReportDriveDownloadDetails $driveDownloadDetails)
    {
