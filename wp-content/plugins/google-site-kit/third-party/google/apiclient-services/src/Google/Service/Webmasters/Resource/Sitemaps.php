 ...
 *  </code>
 */
class Google_Service_Webmasters_Resource_Sitemaps extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($siteUrl, $feedpath, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Webmasters_WmxSitemap");
    }
    /**
    ...
    public function listSitemaps($siteUrl, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Webmasters_SitemapsListResponse");
    }
    /**
