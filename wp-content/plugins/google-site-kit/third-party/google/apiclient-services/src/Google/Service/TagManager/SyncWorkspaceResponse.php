 ...
 * the License.
 */
class Google_Service_TagManager_SyncWorkspaceResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'mergeConflict';
    protected $mergeConflictType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_MergeConflict';
