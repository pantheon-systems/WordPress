 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_Provisioning extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function createAccountTicket(\Google\Site_Kit_Dependencies\Google_Service_Analytics_AccountTicket $postBody, $optParams = array())
    {
     ...
     */
    public function createAccountTree(\Google\Site_Kit_Dependencies\Google_Service_Analytics_AccountTreeRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('createAccountTree', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_AccountTreeResponse");
    }
}
