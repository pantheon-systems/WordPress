 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_PivotHeader extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'pivotHeaderEntries';
    protected $pivotHeaderEntriesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_PivotHeaderEntry';
