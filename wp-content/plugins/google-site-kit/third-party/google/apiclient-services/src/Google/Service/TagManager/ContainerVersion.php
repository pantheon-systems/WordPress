 ...
 * the License.
 */
class Google_Service_TagManager_ContainerVersion extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    protected $containerType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_Container';
    protected $containerDataType = '';
    public $containerId;
    public $containerVersionId;
    protected $customTemplateType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_CustomTemplate';
    ...
    protected $zoneType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_Zone';
     ...
     */
    public function setContainer(\Google\Site_Kit_Dependencies\Google_Service_TagManager_Container $container)
    {
