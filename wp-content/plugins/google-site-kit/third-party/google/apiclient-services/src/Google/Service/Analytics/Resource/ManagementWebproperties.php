 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementWebproperties extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($accountId, $webPropertyId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty");
    }
    /**
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function insert($accountId, \Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('insert', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty");
    }
    /**
    ...
    public function listManagementWebproperties($accountId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperties");
    }
    /**
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function patch($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty");
    }
    /**
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function update($accountId, $webPropertyId, \Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_Webproperty");
    }
}
