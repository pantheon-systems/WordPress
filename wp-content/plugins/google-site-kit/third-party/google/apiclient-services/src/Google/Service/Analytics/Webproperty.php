 ...
 * the License.
 */
class Google_Service_Analytics_Webproperty extends \Google\Site_Kit_Dependencies\Google_Model
{
    public $accountId;
    protected $childLinkType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyChildLink';
    ...
    public $level;
    public $name;
    protected $parentLinkType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyParentLink';
    protected $parentLinkDataType = '';
    protected $permissionsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyPermissions';
     ...
     */
    public function setChildLink(\Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\Google\Site_Kit_Dependencies\Google_Service_Analytics_WebpropertyPermissions $permissions)
    {
