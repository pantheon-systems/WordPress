 ...
 * the License.
 */
class Google_Service_Analytics_AccountSummary extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    public $name;
    public $starred;
    protected $webPropertiesType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_WebPropertySummary';
