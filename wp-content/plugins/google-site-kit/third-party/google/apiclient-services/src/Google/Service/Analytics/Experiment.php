 ...
 * the License.
 */
class Google_Service_Analytics_Experiment extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    protected $parentLinkType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_ExperimentParentLink';
    ...
    public $updated;
    protected $variationsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_ExperimentVariations';
     ...
     */
    public function setParentLink(\Google\Site_Kit_Dependencies\Google_Service_Analytics_ExperimentParentLink $parentLink)
    {
