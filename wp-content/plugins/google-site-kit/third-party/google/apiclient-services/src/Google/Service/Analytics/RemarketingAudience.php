 ...
 * the License.
 */
class Google_Service_Analytics_RemarketingAudience extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'linkedViews';
    public $accountId;
    protected $audienceDefinitionType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_RemarketingAudienceAudienceDefinition';
    ...
    public $kind;
    protected $linkedAdAccountsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_LinkedForeignAccount';
    protected $linkedAdAccountsDataType = 'array';
    public $linkedViews;
    public $name;
    protected $stateBasedAudienceDefinitionType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition';
     ...
     */
    public function setAudienceDefinition(\Google\Site_Kit_Dependencies\Google_Service_Analytics_RemarketingAudienceAudienceDefinition $audienceDefinition)
    {
     ...
     */
    public function setStateBasedAudienceDefinition(\Google\Site_Kit_Dependencies\Google_Service_Analytics_RemarketingAudienceStateBasedAudienceDefinition $stateBasedAudienceDefinition)
    {
