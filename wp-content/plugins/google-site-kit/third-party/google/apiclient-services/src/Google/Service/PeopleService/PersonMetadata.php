 ...
 * the License.
 */
class Google_Service_PeopleService_PersonMetadata extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    protected $sourcesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Source';
