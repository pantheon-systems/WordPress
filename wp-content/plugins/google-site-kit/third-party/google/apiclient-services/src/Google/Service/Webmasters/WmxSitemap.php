 ...
 * the License.
 */
class Google_Service_Webmasters_WmxSitemap extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'contents';
    protected $contentsType = 'Google\Site_Kit_Dependencies\Google_Service_Webmasters_WmxSitemapContent';
