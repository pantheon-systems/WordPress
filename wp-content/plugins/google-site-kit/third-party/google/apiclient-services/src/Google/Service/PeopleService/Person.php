 ...
 * the License.
 */
class Google_Service_PeopleService_Person extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'userDefined';
    protected $addressesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Address';
    protected $addressesDataType = 'array';
    public $ageRange;
    protected $ageRangesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_AgeRangeType';
    protected $ageRangesDataType = 'array';
    protected $biographiesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Biography';
    protected $biographiesDataType = 'array';
    protected $birthdaysType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Birthday';
    protected $birthdaysDataType = 'array';
    protected $braggingRightsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_BraggingRights';
    protected $braggingRightsDataType = 'array';
    protected $coverPhotosType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_CoverPhoto';
    protected $coverPhotosDataType = 'array';
    protected $emailAddressesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_EmailAddress';
    protected $emailAddressesDataType = 'array';
    public $etag;
    protected $eventsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Event';
    protected $eventsDataType = 'array';
    protected $gendersType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Gender';
    protected $gendersDataType = 'array';
    protected $imClientsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_ImClient';
    protected $imClientsDataType = 'array';
    protected $interestsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Interest';
    protected $interestsDataType = 'array';
    protected $localesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Locale';
    protected $localesDataType = 'array';
    protected $membershipsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Membership';
    protected $membershipsDataType = 'array';
    protected $metadataType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_PersonMetadata';
    protected $metadataDataType = '';
    protected $namesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Name';
    protected $namesDataType = 'array';
    protected $nicknamesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Nickname';
    protected $nicknamesDataType = 'array';
    protected $occupationsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Occupation';
    protected $occupationsDataType = 'array';
    protected $organizationsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Organization';
    protected $organizationsDataType = 'array';
    protected $phoneNumbersType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_PhoneNumber';
    protected $phoneNumbersDataType = 'array';
    protected $photosType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Photo';
    protected $photosDataType = 'array';
    protected $relationsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Relation';
    protected $relationsDataType = 'array';
    protected $relationshipInterestsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_RelationshipInterest';
    protected $relationshipInterestsDataType = 'array';
    protected $relationshipStatusesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_RelationshipStatus';
    protected $relationshipStatusesDataType = 'array';
    protected $residencesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Residence';
    protected $residencesDataType = 'array';
    public $resourceName;
    protected $sipAddressesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_SipAddress';
    protected $sipAddressesDataType = 'array';
    protected $skillsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Skill';
    protected $skillsDataType = 'array';
    protected $taglinesType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Tagline';
    protected $taglinesDataType = 'array';
    protected $urlsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_Url';
    protected $urlsDataType = 'array';
    protected $userDefinedType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_UserDefined';
     ...
     */
    public function setMetadata(\Google\Site_Kit_Dependencies\Google_Service_PeopleService_PersonMetadata $metadata)
    {
