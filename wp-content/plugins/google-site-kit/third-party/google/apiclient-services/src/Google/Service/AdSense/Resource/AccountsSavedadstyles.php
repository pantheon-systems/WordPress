 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_AccountsSavedadstyles extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($accountId, $savedAdStyleId, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_SavedAdStyle");
    }
    /**
    ...
    public function listAccountsSavedadstyles($accountId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_SavedAdStyles");
    }
}
