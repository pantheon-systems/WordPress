 ...
 * the License.
 */
class Google_Service_PeopleService_ContactGroup extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    protected $metadataType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroupMetadata';
     ...
     */
    public function setMetadata(\Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroupMetadata $metadata)
    {
