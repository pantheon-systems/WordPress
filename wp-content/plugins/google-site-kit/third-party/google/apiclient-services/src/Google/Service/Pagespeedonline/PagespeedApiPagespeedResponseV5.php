 ...
 * the License.
 */
class Google_Service_Pagespeedonline_PagespeedApiPagespeedResponseV5 extends \Google\Site_Kit_Dependencies\Google_Model
{
    public $analysisUTCTimestamp;
    public $captchaResult;
    public $id;
    public $kind;
    protected $lighthouseResultType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5';
    protected $lighthouseResultDataType = '';
    protected $loadingExperienceType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5';
    protected $loadingExperienceDataType = '';
    protected $originLoadingExperienceType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5';
    protected $originLoadingExperienceDataType = '';
    protected $versionType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiPagespeedResponseV5Version';
     ...
     */
    public function setLighthouseResult(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5 $lighthouseResult)
    {
     ...
     */
    public function setLoadingExperience(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5 $loadingExperience)
    {
     ...
     * @param Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5
     */
    public function setOriginLoadingExperience(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5 $originLoadingExperience)
    {
     ...
     */
    public function setVersion(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiPagespeedResponseV5Version $version)
    {
