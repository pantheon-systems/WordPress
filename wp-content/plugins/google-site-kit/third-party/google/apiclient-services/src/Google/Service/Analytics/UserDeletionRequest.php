 ...
 * the License.
 */
class Google_Service_Analytics_UserDeletionRequest extends \Google\Site_Kit_Dependencies\Google_Model
{
    public $deletionRequestTime;
    public $firebaseProjectId;
    protected $idType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_UserDeletionRequestId';
     ...
     */
    public function setId(\Google\Site_Kit_Dependencies\Google_Service_Analytics_UserDeletionRequestId $id)
    {
        $this->id = $id;
    }
    /**
