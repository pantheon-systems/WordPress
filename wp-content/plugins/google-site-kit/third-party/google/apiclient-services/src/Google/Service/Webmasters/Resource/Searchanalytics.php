 ...
 *  </code>
 */
class Google_Service_Webmasters_Resource_Searchanalytics extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function query($siteUrl, \Google\Site_Kit_Dependencies\Google_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('query', array($params), "Google\Site_Kit_Dependencies\Google_Service_Webmasters_SearchAnalyticsQueryResponse");
    }
}
