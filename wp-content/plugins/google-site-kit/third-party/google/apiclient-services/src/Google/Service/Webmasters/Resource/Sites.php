 ...
 *  </code>
 */
class Google_Service_Webmasters_Resource_Sites extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($siteUrl, $optParams = array())
    {
        $params = array('siteUrl' => $siteUrl);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Webmasters_WmxSite");
    }
    /**
    ...
    public function listSites($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Webmasters_SitesListResponse");
    }
}
