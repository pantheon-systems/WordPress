 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_ReportsSaved extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function generate($savedReportId, $optParams = array())
    {
        ...
        return $this->call('generate', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_AdsenseReportsGenerateResponse");
    }
    /**
    ...
    public function listReportsSaved($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_SavedReports");
    }
}
