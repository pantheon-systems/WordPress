 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_SequenceSegment extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'segmentSequenceSteps';
    public $firstStepShouldMatchFirstHit;
    protected $segmentSequenceStepsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_SegmentSequenceStep';
