 ...
 * the License.
 */
class Google_Service_PeopleService_ListContactGroupsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'contactGroups';
    protected $contactGroupsType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroup';
