 ...
 * the License.
 */
class Google_Service_Analytics_GaDataDataTable extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'rows';
    protected $colsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_GaDataDataTableCols';
