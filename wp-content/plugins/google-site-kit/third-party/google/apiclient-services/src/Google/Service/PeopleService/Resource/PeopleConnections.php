 ...
 *  </code>
 */
class Google_Service_PeopleService_Resource_PeopleConnections extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function listPeopleConnections($resourceName, $optParams = array())
    {
        ...
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ListConnectionsResponse");
    }
}
