 ...
 *  </code>
 */
class Google_Service_PeopleService_Resource_ContactGroupsMembers extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function modify($resourceName, \Google\Site_Kit_Dependencies\Google_Service_PeopleService_ModifyContactGroupMembersRequest $postBody, $optParams = array())
    {
        $params = array('resourceName' => $resourceName, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('modify', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ModifyContactGroupMembersResponse");
    }
}
