 ...
 *  </code>
 */
class Google_Service_TagManager_Resource_AccountsContainersWorkspacesFolders extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function create($parent, \Google\Site_Kit_Dependencies\Google_Service_TagManager_Folder $postBody, $optParams = array())
    {
        $params = array('parent' => $parent, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_Folder");
    }
    /**
    ...
    public function entities($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('entities', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_FolderEntities");
    }
    /**
    ...
    public function get($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_Folder");
    }
    /**
    ...
    public function listAccountsContainersWorkspacesFolders($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ListFoldersResponse");
    }
    /**
    ...
    public function revert($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('revert', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_RevertFolderResponse");
    }
    /**
     ...
     * @return Google_Service_TagManager_Folder
     */
    public function update($path, \Google\Site_Kit_Dependencies\Google_Service_TagManager_Folder $postBody, $optParams = array())
    {
        $params = array('path' => $path, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_Folder");
    }
}
