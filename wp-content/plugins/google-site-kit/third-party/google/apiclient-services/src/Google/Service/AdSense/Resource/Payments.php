 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_Payments extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function listPayments($optParams = array())
    {
        ...
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_Payments");
    }
}
