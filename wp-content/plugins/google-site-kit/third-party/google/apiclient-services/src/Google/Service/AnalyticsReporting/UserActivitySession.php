 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_UserActivitySession extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'activities';
    protected $activitiesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Activity';
