 ...
 * the License.
 */
class Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5 extends \Google\Site_Kit_Dependencies\Google_Model
{
    protected $internal_gapi_mappings = array("initialUrl" => "initial_url", "overallCategory" => "overall_category");
    public $id;
    public $initialUrl;
    protected $metricsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5MetricsElement';
