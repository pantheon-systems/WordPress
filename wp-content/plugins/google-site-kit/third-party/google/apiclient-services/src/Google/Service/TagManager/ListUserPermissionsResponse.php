 ...
 * the License.
 */
class Google_Service_TagManager_ListUserPermissionsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'userPermission';
    public $nextPageToken;
    protected $userPermissionType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_UserPermission';
