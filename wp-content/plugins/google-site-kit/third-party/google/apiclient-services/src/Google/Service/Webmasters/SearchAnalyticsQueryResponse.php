 ...
 * the License.
 */
class Google_Service_Webmasters_SearchAnalyticsQueryResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'rows';
    public $responseAggregationType;
    protected $rowsType = 'Google\Site_Kit_Dependencies\Google_Service_Webmasters_ApiDataRow';
