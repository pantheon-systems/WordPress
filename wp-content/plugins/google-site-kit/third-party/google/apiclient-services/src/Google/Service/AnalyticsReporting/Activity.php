 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_Activity extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'customDimension';
    public $activityTime;
    public $activityType;
    protected $appviewType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ScreenviewData';
    protected $appviewDataType = '';
    public $campaign;
    public $channelGrouping;
    protected $customDimensionType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_CustomDimension';
    protected $customDimensionDataType = 'array';
    protected $ecommerceType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_EcommerceData';
    protected $ecommerceDataType = '';
    protected $eventType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_EventData';
    protected $eventDataType = '';
    protected $goalsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_GoalSetData';
    protected $goalsDataType = '';
    public $hostname;
    public $keyword;
    public $landingPagePath;
    public $medium;
    protected $pageviewType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_PageviewData';
     ...
     */
    public function setAppview(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ScreenviewData $appview)
    {
     ...
     */
    public function setEcommerce(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_EcommerceData $ecommerce)
    {
     ...
     */
    public function setEvent(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_EventData $event)
    {
        $this->event = $event;
    }
    /**
     ...
     */
    public function setGoals(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_GoalSetData $goals)
    {
        $this->goals = $goals;
    }
    /**
     ...
     */
    public function setPageview(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_PageviewData $pageview)
    {
