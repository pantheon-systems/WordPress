 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_AccountsAdunits extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'adUnitId' => $adUnitId);
        $params = \array_merge($params, $optParams);
        return $this->call('getAdCode', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_AdCode");
    }
    /**
    ...
    public function listAccountsAdunits($accountId, $adClientId, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_AdUnits");
    }
}
