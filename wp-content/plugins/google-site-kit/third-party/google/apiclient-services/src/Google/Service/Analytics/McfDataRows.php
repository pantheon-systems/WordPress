 ...
 * the License.
 */
class Google_Service_Analytics_McfDataRows extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'conversionPathValue';
    protected $conversionPathValueType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_McfDataRowsConversionPathValue';
