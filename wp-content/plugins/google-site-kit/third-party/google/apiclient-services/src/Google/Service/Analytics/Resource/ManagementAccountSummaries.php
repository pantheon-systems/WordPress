 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementAccountSummaries extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function listManagementAccountSummaries($optParams = array())
    {
        ...
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_AccountSummaries");
    }
}
