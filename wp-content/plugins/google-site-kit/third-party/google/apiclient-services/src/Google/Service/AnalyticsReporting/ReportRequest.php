 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_ReportRequest extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'segments';
    protected $cohortGroupType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_CohortGroup';
    protected $cohortGroupDataType = '';
    protected $dateRangesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_DateRange';
    protected $dateRangesDataType = 'array';
    protected $dimensionFilterClausesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_DimensionFilterClause';
    protected $dimensionFilterClausesDataType = 'array';
    protected $dimensionsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Dimension';
    protected $dimensionsDataType = 'array';
    public $filtersExpression;
    public $hideTotals;
    public $hideValueRanges;
    public $includeEmptyRows;
    protected $metricFilterClausesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_MetricFilterClause';
    protected $metricFilterClausesDataType = 'array';
    protected $metricsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Metric';
    protected $metricsDataType = 'array';
    protected $orderBysType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_OrderBy';
    protected $orderBysDataType = 'array';
    public $pageSize;
    public $pageToken;
    protected $pivotsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Pivot';
    protected $pivotsDataType = 'array';
    public $samplingLevel;
    protected $segmentsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Segment';
    protected $segmentsDataType = 'array';
    public $viewId;
    /**
     * @param Google_Service_AnalyticsReporting_CohortGroup
     */
    public function setCohortGroup(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_CohortGroup $cohortGroup)
    {
