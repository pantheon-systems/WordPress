 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_DataRealtime extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($ids, $metrics, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_RealtimeData");
    }
}
