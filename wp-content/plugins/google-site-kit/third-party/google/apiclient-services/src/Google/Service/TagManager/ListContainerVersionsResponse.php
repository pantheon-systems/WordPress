 ...
 * the License.
 */
class Google_Service_TagManager_ListContainerVersionsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'containerVersionHeader';
    protected $containerVersionHeaderType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersionHeader';
