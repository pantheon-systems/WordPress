 ...
 * the License.
 */
class Google_Service_Pagespeedonline_LighthouseResultV5 extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'stackPacks';
    protected $auditsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseAuditResultV5';
    protected $auditsDataType = 'map';
    protected $categoriesType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Categories';
    protected $categoriesDataType = '';
    protected $categoryGroupsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5CategoryGroupsElement';
    protected $categoryGroupsDataType = 'map';
    protected $configSettingsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5ConfigSettings';
    protected $configSettingsDataType = '';
    protected $environmentType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Environment';
    protected $environmentDataType = '';
    public $fetchTime;
    public $finalUrl;
    protected $i18nType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5I18n';
    protected $i18nDataType = '';
    public $lighthouseVersion;
    public $requestedUrl;
    public $runWarnings;
    protected $runtimeErrorType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5RuntimeError';
    protected $runtimeErrorDataType = '';
    protected $stackPacksType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5StackPacks';
    protected $stackPacksDataType = 'array';
    protected $timingType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Timing';
     ...
     */
    public function setCategories(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Categories $categories)
    {
     ...
     */
    public function setConfigSettings(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5ConfigSettings $configSettings)
    {
     ...
     */
    public function setEnvironment(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Environment $environment)
    {
     ...
     */
    public function setI18n(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5I18n $i18n)
    {
        $this->i18n = $i18n;
    }
    /**
     ...
     */
    public function setRuntimeError(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5RuntimeError $runtimeError)
    {
     ...
     */
    public function setTiming(\Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseResultV5Timing $timing)
    {
        $this->timing = $timing;
    }
    /**
