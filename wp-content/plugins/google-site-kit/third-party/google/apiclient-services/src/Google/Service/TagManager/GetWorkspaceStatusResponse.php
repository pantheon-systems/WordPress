 ...
 * the License.
 */
class Google_Service_TagManager_GetWorkspaceStatusResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    protected $workspaceChangeType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_Entity';
