 ...
 *  </code>
 */
class Google_Service_Partners_Resource_Analytics extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function listAnalytics($optParams = array())
    {
        ...
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Partners_ListAnalyticsResponse");
    }
}
