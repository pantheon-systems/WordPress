 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_MetricHeader extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'pivotHeaders';
    protected $metricHeaderEntriesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_MetricHeaderEntry';
    protected $metricHeaderEntriesDataType = 'array';
    protected $pivotHeadersType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_PivotHeader';
