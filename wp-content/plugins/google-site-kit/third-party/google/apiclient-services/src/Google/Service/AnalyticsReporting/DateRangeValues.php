 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_DateRangeValues extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'values';
    protected $pivotValueRegionsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_PivotValueRegion';
