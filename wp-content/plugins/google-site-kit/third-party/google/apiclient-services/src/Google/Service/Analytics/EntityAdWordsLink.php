 ...
 * the License.
 */
class Google_Service_Analytics_EntityAdWordsLink extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'profileIds';
    protected $adWordsAccountsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_AdWordsAccount';
    protected $adWordsAccountsDataType = 'array';
    protected $entityType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_EntityAdWordsLinkEntity';
     ...
     */
    public function setEntity(\Google\Site_Kit_Dependencies\Google_Service_Analytics_EntityAdWordsLinkEntity $entity)
    {
        $this->entity = $entity;
    }
    /**
