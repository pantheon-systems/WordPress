 ...
 * the License.
 */
class Google_Service_Analytics_Profile extends \Google\Site_Kit_Dependencies\Google_Model
{
    public $accountId;
    public $botFilteringEnabled;
    protected $childLinkType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfileChildLink';
    ...
    public $kind;
    public $name;
    protected $parentLinkType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfileParentLink';
    protected $parentLinkDataType = '';
    protected $permissionsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfilePermissions';
     ...
     */
    public function setChildLink(\Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfileChildLink $childLink)
    {
     ...
     */
    public function setParentLink(\Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfileParentLink $parentLink)
    {
     ...
     */
    public function setPermissions(\Google\Site_Kit_Dependencies\Google_Service_Analytics_ProfilePermissions $permissions)
    {
