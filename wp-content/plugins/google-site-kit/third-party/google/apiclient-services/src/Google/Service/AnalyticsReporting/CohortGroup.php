 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_CohortGroup extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'cohorts';
    protected $cohortsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Cohort';
