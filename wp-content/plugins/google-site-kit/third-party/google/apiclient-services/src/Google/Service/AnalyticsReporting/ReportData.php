 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_ReportData extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'totals';
    public $dataLastRefreshed;
    public $isDataGolden;
    protected $maximumsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_DateRangeValues';
    protected $maximumsDataType = 'array';
    protected $minimumsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_DateRangeValues';
    protected $minimumsDataType = 'array';
    public $rowCount;
    protected $rowsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ReportRow';
    protected $rowsDataType = 'array';
    public $samplesReadCounts;
    public $samplingSpaceSizes;
    protected $totalsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_DateRangeValues';
