 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_OrFiltersForSegment extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'segmentFilterClauses';
    protected $segmentFilterClausesType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_SegmentFilterClause';
