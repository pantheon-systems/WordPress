 ...
 * the License.
 */
class Google_Service_Webmasters_SearchAnalyticsQueryRequest extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'dimensions';
    public $aggregationType;
    protected $dimensionFilterGroupsType = 'Google\Site_Kit_Dependencies\Google_Service_Webmasters_ApiDimensionFilterGroup';
