 ...
 * the License.
 */
class Google_Service_TagManager_UserPermission extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'containerAccess';
    protected $accountAccessType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_AccountAccess';
    protected $accountAccessDataType = '';
    public $accountId;
    protected $containerAccessType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerAccess';
     ...
     */
    public function setAccountAccess(\Google\Site_Kit_Dependencies\Google_Service_TagManager_AccountAccess $accountAccess)
    {
