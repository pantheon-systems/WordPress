 ...
 * the License.
 */
class Google_Service_TagManager_ZoneBoundary extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'customEvaluationTriggerId';
    protected $conditionType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_Condition';
