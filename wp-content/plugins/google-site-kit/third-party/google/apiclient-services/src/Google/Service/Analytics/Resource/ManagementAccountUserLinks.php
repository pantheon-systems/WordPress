 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementAccountUserLinks extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function insert($accountId, \Google\Site_Kit_Dependencies\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityUserLink
     */
    public function update($accountId, $linkId, \Google\Site_Kit_Dependencies\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
