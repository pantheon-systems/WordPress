 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_GetReportsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'reports';
    public $queryCost;
    protected $reportsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_Report';
    protected $reportsDataType = 'array';
    protected $resourceQuotasRemainingType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ResourceQuotasRemaining';
     ...
     */
    public function setResourceQuotasRemaining(\Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ResourceQuotasRemaining $resourceQuotasRemaining)
    {
