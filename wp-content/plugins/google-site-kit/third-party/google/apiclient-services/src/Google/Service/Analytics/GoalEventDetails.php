 ...
 * the License.
 */
class Google_Service_Analytics_GoalEventDetails extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'eventConditions';
    protected $eventConditionsType = 'Google\Site_Kit_Dependencies\Google_Service_Analytics_GoalEventDetailsEventConditions';
