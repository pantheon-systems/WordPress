 ...
 * the License.
 */
class Google_Service_TagManager_Variable extends \Google\Site_Kit_Dependencies\Google_Collection
{
    ...
    public $fingerprint;
    protected $formatValueType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_VariableFormatValue';
     ...
     */
    public function setFormatValue(\Google\Site_Kit_Dependencies\Google_Service_TagManager_VariableFormatValue $formatValue)
    {
