 ...
 * the License.
 */
class Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5MetricsElement extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'distributions';
    public $category;
    protected $distributionsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_PagespeedApiLoadingExperienceV5MetricsElementDistributions';
