 ...
 *  </code>
 */
class Google_Service_TagManager_Resource_AccountsContainersVersions extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function live($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('live', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function publish($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('publish', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_PublishContainerVersionResponse");
    }
    /**
    ...
    public function set_latest($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('set_latest', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion");
    }
    /**
    ...
    public function undelete($path, $optParams = array())
    {
        $params = array('path' => $path);
        $params = \array_merge($params, $optParams);
        return $this->call('undelete', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion");
    }
    /**
     ...
     * @return Google_Service_TagManager_ContainerVersion
     */
    public function update($path, \Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion $postBody, $optParams = array())
    {
        $params = array('path' => $path, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion");
    }
}
