 ...
 * the License.
 */
class Google_Service_AnalyticsReporting_GetReportsRequest extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'reportRequests';
    protected $reportRequestsType = 'Google\Site_Kit_Dependencies\Google_Service_AnalyticsReporting_ReportRequest';
