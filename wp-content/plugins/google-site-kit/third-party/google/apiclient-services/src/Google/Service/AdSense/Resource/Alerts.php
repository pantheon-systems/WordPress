 ...
 *  </code>
 */
class Google_Service_AdSense_Resource_Alerts extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function listAlerts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_AdSense_Alerts");
    }
}
