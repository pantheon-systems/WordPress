 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_DataMcf extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($ids, $startDate, $endDate, $metrics, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Analytics_McfData");
    }
}
