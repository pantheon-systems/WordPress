 ...
 * the License.
 */
class Google_Service_TagManager_CreateContainerVersionResponse extends \Google\Site_Kit_Dependencies\Google_Model
{
    public $compilerError;
    protected $containerVersionType = 'Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion';
     ...
     */
    public function setContainerVersion(\Google\Site_Kit_Dependencies\Google_Service_TagManager_ContainerVersion $containerVersion)
    {
     ...
     */
    public function setSyncStatus(\Google\Site_Kit_Dependencies\Google_Service_TagManager_SyncStatus $syncStatus)
    {
