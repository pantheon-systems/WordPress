 ...
 * the License.
 */
class Google_Service_Pagespeedonline_LighthouseCategoryV5 extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'auditRefs';
    protected $auditRefsType = 'Google\Site_Kit_Dependencies\Google_Service_Pagespeedonline_LighthouseCategoryV5AuditRefs';
