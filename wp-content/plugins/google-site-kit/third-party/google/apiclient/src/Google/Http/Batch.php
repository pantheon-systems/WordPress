...
class Google_Http_Batch
{
    ...
    private $rootUrl;
    private $batchPath;
    public function __construct(\Google\Site_Kit_Dependencies\Google_Client $client, $boundary = \false, $rootUrl = null, $batchPath = null)
    {
        $this->client = $client;
        ...
        if (!empty($body)) {
            ...
            foreach ($parts as $i => $part) {
                ...
                if (!empty($part)) {
                    ...
                    try {
                        $response = \Google\Site_Kit_Dependencies\Google_Http_REST::decodeHttpResponse($response, $requests[$i - 1]);
                    } catch (\Google\Site_Kit_Dependencies\Google_Service_Exception $e) {
