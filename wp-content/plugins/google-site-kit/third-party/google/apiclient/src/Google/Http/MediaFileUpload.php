...
class Google_Http_MediaFileUpload
{
     ...
     */
    public function __construct(\Google\Site_Kit_Dependencies\Google_Client $client, \Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $request, $mimeType, $data, $resumable = \false, $chunkSize = \false)
    {
        $this->client = $client;
    ...
    private function makePutRequest(\Google\Site_Kit_Dependencies\Psr\Http\Message\RequestInterface $request)
    {
        ...
        return \Google\Site_Kit_Dependencies\Google_Http_REST::decodeHttpResponse($response, $this->request);
    }
    /**
    ...
    private function fetchResumeUri()
    {
        ...
        throw new \Google\Site_Kit_Dependencies\Google_Exception($error);
    }
