...
class Transaction
{
     ...
     */
    public function __construct(\Google\Site_Kit_Dependencies\GuzzleHttp\ClientInterface $client, \Google\Site_Kit_Dependencies\GuzzleHttp\Message\RequestInterface $request, $future = \false)
    {
        $this->client = $client;
