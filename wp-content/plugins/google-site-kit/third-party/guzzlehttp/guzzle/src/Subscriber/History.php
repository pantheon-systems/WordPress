 ...
 */
class History implements \Google\Site_Kit_Dependencies\GuzzleHttp\Event\SubscriberInterface, \IteratorAggregate, \Countable
{
    ...
    {
        return ['complete' => ['onComplete', \Google\Site_Kit_Dependencies\GuzzleHttp\Event\RequestEvents::EARLY], 'error' => ['onError', \Google\Site_Kit_Dependencies\GuzzleHttp\Event\RequestEvents::EARLY]];
    }
    /**
    ...
    public function onError(\Google\Site_Kit_Dependencies\GuzzleHttp\Event\ErrorEvent $event)
    {
     ...
     */
    private function add(\Google\Site_Kit_Dependencies\GuzzleHttp\Message\RequestInterface $request, \Google\Site_Kit_Dependencies\GuzzleHttp\Message\ResponseInterface $response = null)
    {
