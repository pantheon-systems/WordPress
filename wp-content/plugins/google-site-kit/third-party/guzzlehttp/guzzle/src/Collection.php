 ...
 */
class Collection implements \ArrayAccess, \IteratorAggregate, \Countable, \Google\Site_Kit_Dependencies\GuzzleHttp\ToArrayInterface
{
    use HasDataTrait;
    /**
    ...
    {
        return \array_search($value, $this->data, \true);
    }
    /**
    ...
    public function overwriteWith($data)
    {
        ...
        } elseif ($data instanceof \Google\Site_Kit_Dependencies\GuzzleHttp\Collection) {
