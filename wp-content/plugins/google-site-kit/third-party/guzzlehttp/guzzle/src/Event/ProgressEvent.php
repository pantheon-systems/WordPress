 ...
 */
class ProgressEvent extends \Google\Site_Kit_Dependencies\GuzzleHttp\Event\AbstractRequestEvent
{
     ...
     */
    public function __construct(\Google\Site_Kit_Dependencies\GuzzleHttp\Transaction $transaction, $downloadSize, $downloaded, $uploadSize, $uploaded)
    {
