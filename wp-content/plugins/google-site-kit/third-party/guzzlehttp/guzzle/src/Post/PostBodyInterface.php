 ...
 */
interface PostBodyInterface extends \Google\Site_Kit_Dependencies\GuzzleHttp\Stream\StreamInterface, \Countable, \Google\Site_Kit_Dependencies\GuzzleHttp\Message\AppliesHeadersInterface
{
    /**
