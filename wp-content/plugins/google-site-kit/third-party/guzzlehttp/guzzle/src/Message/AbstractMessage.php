...
abstract class AbstractMessage implements \Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface
{
    ...
    public function setBody(\Google\Site_Kit_Dependencies\GuzzleHttp\Stream\StreamInterface $body = null)
    {
        if ($body === null) {
     ...
     */
    public static function parseHeader(\Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface $message, $header)
    {
        static $trimmed = "\"'  \n\t\r";
        $params = $matches = [];
     ...
     */
    public static function normalizeHeader(\Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface $message, $header)
    {
     ...
     * @return string
     */
    public static function getStartLineAndHeaders(\Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface $message)
    {
     ...
     * @return string
     */
    public static function getHeadersAsString(\Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface $message)
    {
        $result = '';
    ...
    {
        if ($message instanceof \Google\Site_Kit_Dependencies\GuzzleHttp\Message\RequestInterface) {
            return \trim($message->getMethod() . ' ' . $message->getResource()) . ' HTTP/' . $message->getProtocolVersion();
        } elseif ($message instanceof \Google\Site_Kit_Dependencies\GuzzleHttp\Message\ResponseInterface) {
