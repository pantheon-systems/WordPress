...
class MessageParser
{
    ...
    public function parseRequest($message)
    {
        ...
        $parsed = ['method' => \strtoupper($parts['start_line'][0]), 'protocol' => $protocol, 'protocol_version' => $version, 'headers' => $parts['headers'], 'body' => $parts['body']];
    ...
    public function parseResponse($message)
    {
        ...
        return ['protocol' => $protocol, 'protocol_version' => $version, 'code' => $parts['start_line'][1], 'reason_phrase' => isset($parts['start_line'][2]) ? $parts['start_line'][2] : '', 'headers' => $parts['headers'], 'body' => $parts['body']];
    }
    /**
    ...
    private function parseMessage($message)
    {
        ...
        return ['start_line' => $startLine, 'headers' => $headers, 'body' => $body];
    }
    /**
