...
use Google\Site_Kit_Dependencies\GuzzleHttp\Event\HasEmitterInterface;
use Google\Site_Kit_Dependencies\GuzzleHttp\Query;
/**
 * Generic HTTP request interface
 */
interface RequestInterface extends \Google\Site_Kit_Dependencies\GuzzleHttp\Message\MessageInterface, \Google\Site_Kit_Dependencies\GuzzleHttp\Event\HasEmitterInterface
{
    /**
