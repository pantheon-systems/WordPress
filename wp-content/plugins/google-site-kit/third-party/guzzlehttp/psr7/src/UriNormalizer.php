...
final class UriNormalizer
{
     ...
     */
    public static function normalize(\Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri, $flags = self::PRESERVING_NORMALIZATIONS)
    {
     ...
     */
    public static function isEquivalent(\Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri1, \Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri2, $normalizations = self::PRESERVING_NORMALIZATIONS)
    {
        return (string) self::normalize($uri1, $normalizations) === (string) self::normalize($uri2, $normalizations);
    }
    private static function capitalizePercentEncoding(\Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri)
    {
        $regex = '/(?:%[A-Fa-f0-9]{2})++/';
    ...
    private static function decodeUnreservedCharacters(\Google\Site_Kit_Dependencies\Psr\Http\Message\UriInterface $uri)
    {
