 ...
 */
class InflateStream implements \Google\Site_Kit_Dependencies\Psr\Http\Message\StreamInterface
{
    ...
    public function __construct(\Google\Site_Kit_Dependencies\Psr\Http\Message\StreamInterface $stream)
    {
        ...
        $stream = new \Google\Site_Kit_Dependencies\GuzzleHttp\Psr7\LimitStream($stream, -1, 10 + $filenameHeaderLength);
     ...
     * @return int
     */
    private function getLengthOfPossibleFilenameHeader(\Google\Site_Kit_Dependencies\Psr\Http\Message\StreamInterface $stream, $header)
    {
