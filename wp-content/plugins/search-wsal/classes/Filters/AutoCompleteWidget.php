...
class WSAL_AS_Filters_AutoCompleteWidget extends WSAL_AS_Filters_AbstractWidget {
    ...
    {
        if (is_string($tokens)) $tokens = array($tokens);
        $this->loaded_data[] = array('value' => $nice, 'tokens' => array_unique($tokens));
    }
    ...
    protected function RenderField()
    {
        ?><input type="text" autocomplete="off"
                ...
                data-filter="<?php echo esc_attr($this->filter->GetSafeName()); ?>"/><?php
    }
