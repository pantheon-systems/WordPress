...
<div class="ebanx-thank-you-page ebanx-thank-you-page--ar ebanx-thank-you-page--cc-ar">
	<?php if ( $instalments_number > 1 ) : ?>
		<p><strong><?php echo esc_html( $customer_name ); ?> tu pago de <?php echo $total; // phpcs:ignore WordPress.XSS.EscapeOutput ?>, dividido en <span id="ebanx-instalment-number"><?php echo esc_html( $instalments_number ); ?> meses de <?php echo $instalments_amount; // phpcs:ignore WordPress.XSS.EscapeOutput ?>, fue aprobado</strong></p>
	<?php else : ?>
