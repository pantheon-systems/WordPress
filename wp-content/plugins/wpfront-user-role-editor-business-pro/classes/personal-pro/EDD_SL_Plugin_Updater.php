...
class EDD_SL_Plugin_Updater {
    ...
    public function show_update_notification( $file, $plugin ) {
        ...
        if ( empty( $update_cache->response ) || empty( $update_cache->response[ $this->name ] ) ) {
            ...
            if(!empty($version_info) && version_compare( $this->version, $version_info->new_version, '<' ) ) {
        ...
        if (isset($version_info) && ! empty( $update_cache->response[ $this->name ] ) && version_compare( $this->version, $version_info->new_version, '<' ) ) {
    ...
    protected function api_request( $_action, $_data ) {
        ...
        $request = WPFront_User_Role_Editor::wp_remote_get($this->api_url, array('body' => $api_params));
