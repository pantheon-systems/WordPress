...
var Switcher = function () {
	...
	_createClass(Switcher, [{
		...
		key: 'reorganizeElements',
		value: function reorganizeElements() {
			if (this.heading.length) {
				this.heading.item(this.heading.length - 1).parentNode.insertBefore(this.toggleGroup, this.heading.item(this.heading.length - 1).nextSibling);
			} else {
