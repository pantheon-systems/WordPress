...
//region VALIDATE TRIGGERS
    ...
    var validateTrigger = function(triggerContainer, select2Selected, select3Selected, input1){
        var validValues = ["ALERT CODE", "DATE", "TIME", "USERNAME", "USER ROLE", "SOURCE IP", "POST ID", "PAGE ID", "CUSTOM POST ID", "SITE DOMAIN", "POST TYPE"]
    ...
    this.validate = function()
    {
        ...
        if(triggers.length){
            $.each(triggers, function(){
                ...
                var result = validateTrigger($this, select2, select3, $input1);
                if(result !== true) {
