		...
		<div class="post-content">
			...
			if ( $using_masonry == true && $masonry_type == 'classic_enhanced' ) {
				...
				if ( $img_size == 'regular' ) {
					$image_attrs = array(
						'title' => '',
						'sizes' => '(min-width: 1600px) 20vw, (min-width: 1300px) 25vw, (min-width: 1000px) 33vw, (min-width: 690px) 100vw, 100vw',
					);
				} elseif ( $img_size == 'wide_tall' ) {
					$image_attrs = array(
						'title' => '',
						'sizes' => '(min-width: 1600px) 25vw, (min-width: 1300px) 40vw, (min-width: 1000px) 50vw, (min-width: 690px) 50vw, 100vw',
					);
			...
			if ( $using_masonry == true && $masonry_type == 'classic_enhanced' && ! is_single() ) {
				echo '<a href="' . esc_url( get_permalink() ) . '" class="img-link"><span class="post-featured-img">' . get_the_post_thumbnail( $post->ID, $img_size, $image_attrs ) . '</span></a>';
			}
				...
				<div class="content-inner">
					...
					if ( has_post_thumbnail() ) {
						...
						if ( ! is_single() ) {
							...
							} elseif ( $using_masonry == true && $masonry_type == 'classic' ) {
								$image_attrs = array(
									'title' => '',
									'sizes' => '(min-width: 1600px) 20vw, (min-width: 1300px) 25vw, (min-width: 1000px) 33.3vw, (min-width: 690px) 50vw, 100vw',
								);
							...
							} elseif ( ! ( $using_masonry == true && $masonry_type == 'classic_enhanced' ) ) {
						...
						<div class="article-content-wrap">
							...
							<div class="post-header">
								...
								<?php if ( ! ( $masonry_type == 'classic_enhanced' && $using_masonry == true ) && ! ( $using_masonry == true && $masonry_type == 'material' ) ) { ?> 
									<span class="meta-author"><span><?php echo esc_html__( 'By', 'salient' ); ?></span> <?php the_author_posts_link(); ?></span> <span class="meta-category">| <?php the_category( ', ' ); ?></span> 
