 ...
 <div class="row page-header-no-bg">
		<div class="container">	
			<div class="col span_12 section-title">
				...
				<h1> <?php $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); if ( $term ) { echo esc_html( $term->name ); } else { wp_title( '', true ); } ?> </h1>
								...
								<div class="work-info"> 
									...
									<div class="vert-center">
												...
												// image
													...
													echo '<a href="' . esc_url( $featured_image[0] ) . '" class="pretty_photo default-link" >' . esc_html__( 'View Larger', 'salient' ) . '</a> ';
												}
	...
	if ( ! empty( $video_embed ) || ! empty( $video_m4v ) ) {
		...
		if ( ! empty( $options['portfolio_extra_pagination'] ) && $options['portfolio_extra_pagination'] == '1' ) {
			...
			if ( $total_pages > 1 ) {
				...
				echo '<div id="pagination" class="' . $fw_pagination . ' ' . $masonry_padding . esc_attr( $infinite_scroll_class ) . '" data-is-text="' . esc_attr__( 'All items loaded', 'salient' ) . '">'; // WPCS: XSS ok.
			...
			if ( get_next_posts_link() || get_previous_posts_link() ) {
				...
				echo '<div id="pagination" class="' . $fw_pagination . ' ' . $masonry_padding . esc_attr( $infinite_scroll_class ) . '" data-is-text="' . esc_attr__( 'All items loaded', 'salient' ) . '">
