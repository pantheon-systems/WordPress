...
$icon_arr = array_merge($fa_icons, $steadysets, $linecons);
	...
	return array(
	  "name" => esc_html__("Text With Icon", "js_composer"),
	  "base" => "text-with-icon",
	  "icon" => "icon-wpb-text-with-icon",
	  "category" => esc_html__('Nectar Elements', 'js_composer'),
	  "weight" => 1,
	  "description" => esc_html__('Add a text block with stylish icon', 'js_composer'),
	  "params" => array(
	    array(
		  "type" => "dropdown",
		  ...
		  'save_always' => true,
		  "description" => esc_html__("Please select type of icon you would like for the text block", "js_composer")
		),
		array(
		  "type" => "dropdown",
