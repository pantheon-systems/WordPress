	...
	<ul>
		<?php if ( $share_facebook_enabled ) : ?>
			<li style="list-style-type: none; display: inline-block;">
				<a target="_blank" class="facebook" href="https://www.facebook.com/sharer.php?s=100&amp;p%5Btitle%5D=<?php echo $share_link_title; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>&amp;p%5Burl%5D=<?php echo urlencode( $share_link_url ); ?>"><?Php oceanwp_icon( 'facebook' ); ?></a>
		...
		<?php if ( $share_twitter_enabled ) : ?>
			<li style="list-style-type: none; display: inline-block;">
				<a target="_blank" class="twitter" href="https://twitter.com/share?url=<?php echo urlencode( $share_link_url ); ?>&amp;text=<?php echo $share_twitter_summary; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"><?Php oceanwp_icon( 'twitter' ); ?></a>
		...
		<?php if ( $share_pinterest_enabled ) : ?>
			<li style="list-style-type: none; display: inline-block;">
				<a target="_blank" class="pinterest" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode( $share_link_url ); ?>&amp;description=<?php echo $share_summary; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>&amp;media=<?php echo $share_image_url; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" onclick="window.open(this.href); return false;"><?Php oceanwp_icon( 'pinterest' ); ?></a>
